...
function MentionsContent() {
  ...
  if (!data) return <div className="h-screen flex items-center justify-center bg-[#FDFBF5] font-cursive text-xl">Loading Mentions...</div>
...
export default function MentionsPage() { return <Suspense><MentionsContent /></Suspense> }